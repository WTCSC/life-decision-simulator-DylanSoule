...
if input("Welcome to your new life, to begin you get home from school and are confronted with a choice. Do you do your homework or not?(yes/no)\n").lower() == "yes":
    ...
    if math_hw and english_hw:
        ...
        if input("Do you drop out of school now?(yes/no)\n").lower() == "yes":
            ...
            print("You're so honorable, with this goodness in you, you end up becoming a wealthy charitable man, and live happily and die with a good legacy.")
        ...
        print("Russia bombs the United States because you didn't solve the math problems quick enough to help the government protect the country. The world goes into nuclear fallout.")
        ...
        print("Because of this one homework assignment you decide to become and english major, unfortunately because of this you are now homeless.")
    ...
    if input("Do you answer it?(yes/no)\n").lower() == "yes":
        ...
        if input("Do you invite him in for tea?(yes/no)\n").lower() == "yes":
            ...
            if tea == "earl grey":
                print("Arnold loves your choice, and because of that, he decides not to kill you. However, because of this you end up starting the robot war and the earth is nuked and split into millions of pieces.")
            elif tea == "black":
                print("Arnold doesn't like your choice, but he respects it. He takes you to the future and you end up becoming a general that fights robots. But they don't exist because you didn't invent them. You are then stuck in a paradox and live in immesurable pain.")
            elif tea == "green":
        ...
        terminating = True
if terminating == True:
    print("Thats too bad! The terminator comes in and eliminates you because you are the one that invents robots in the the future and ruins humanity. Sorry.")
if bankrob == True:
    print("While you are robbing the bank, a cop comes in to deposit some money and arrests you.")
...
if nobankrob == True:
    print("Because you decided to not rob the bank, and angel comes down and blesses you with a good life as you are a good person at heart.")