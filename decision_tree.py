...
if input("Welcome to your new life, to begin you get home from school and are confronted with a choice. Do you do your homework or not?(yes/no)\n").lower() == "yes":
    ...
    if math_hw and english_hw:
        ...
        if input("Do you apologize?(yes/no)\n").lower() == "yes":
            print("Your teacher reveales themselves to be Zues, and becuase you were nice to him, you get to become the god of math homework, and live in eternal joy as your sadistic self watched highschool kids struggle with their homework.")
        else:
            terminating = True
